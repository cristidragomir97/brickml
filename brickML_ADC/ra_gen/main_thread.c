...
static StaticTask_t main_thread_memory;
                ...
                static uint8_t main_thread_stack[16384] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
static uint8_t main_thread_stack[16384] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.main_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
#endif
#endif
...
#endif
  .ipl = (1),
  .ipl_r = (1), .ipl_d0 = (1), .ipl_d1 = (1), .hsipl = (1), .hsipl_d0 = (BSP_IRQ_DISABLED), .hsipl_d1 =
          (BSP_IRQ_DISABLED),
#if (BSP_CFG_RTOS != 0)
...
void main_thread_create(void)
{
    ...
    main_thread = xTaskCreateStatic (
                    ...
                    #endif
                                     main_thread_func,
                                     (const char*) "MainThread", 16384 / 4, // In words, not bytes

...
/* Actual calculated bitrate: 99642. Actual calculated duty cycle: 50%. */.clock_settings.brl_value = 27,
  .clock_settings.brh_value = 27, .clock_settings.cks_value = 3, };
...
#undef RA_NOT_DEFINED
  .p_callback = wire_master_callback,
  .p_context = NULL,
...
baud_setting_t g_uart0_baud_setting =
        {
        /* Baud rate calculated with 0.318% error. */.semr_baudrate_bits_b.abcse = 0,
